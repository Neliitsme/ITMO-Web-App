function switchLight() {
  ...
  document
    .querySelector('.topnav__navbox_nav_list_item-active')
    .classList.toggle('item-active-darkmode');
  ...
  document
    .querySelector('.topnav__navbox_nav_show')
    .classList.toggle('topnav__navbox_nav_show-darkmode');
}
